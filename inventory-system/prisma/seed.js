...
async function main() {
  ...
  // 4. Create Products (with correct unit storage conversions)
  // Weight: Stored in grams (g)
  // Volume: Stored in milliliters (mL)
  // Count: Stored in items (item)
  const products = [
    {
      name: 'White Sugar',
      sku: 'GRO-SUG-A9F3',
      category: 'Groceries',
      baseUnit: 'g',
      basePrice: 0.05, // Stored as ₹0.05 per gram (Translates to ₹50 per kg)
    ...
    },
    {
      ...
      category: 'Groceries',
      baseUnit: 'mL',
      basePrice: 0.06, // Stored as ₹0.06 per mL (Translates to ₹60 per L)
    ...
    },
    {
      ...
      category: 'Groceries',
      baseUnit: 'g',
      basePrice: 0.04, // Stored as ₹0.04 per gram (Translates to ₹40 per kg)
